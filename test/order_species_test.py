...
def test_order_species():
    ...
    species_list = ["Fred", 'TROPOMICLOUDSURFACEALBEDO', "Carl", 'TROPOMITEMPSHIFTBAND11',
                    "Al"]
    assert order_species(species_list) == ['TROPOMICLOUDSURFACEALBEDO', "Al", "Carl", "Fred", 'TROPOMITEMPSHIFTBAND11']
