...
from refractor.muses import mpy_radiance_from_observation_list, FilterIdentifier, FilterResultSummary
...
def test_filter_result_summary(joint_tropomi_step_12):
    ...
    assert fsummary.filter_slice == [slice(0, 2720), slice(0, 717), slice(717, 1586), slice(1586, 2223), slice(2223, 2720)]
