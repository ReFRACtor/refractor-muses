...
def build_state_from_sounding(sounding_dir, atm_state_file, tropomi_state_file, src_rad_file=None, src_irr_file=None):
    ...
    atm_species = {'TATM': 'temperature', 'CO': 'co', 'CH4': 'ch4', 'H2O': 'h2o', 'HDO': 'hdo'}
...
def _make_atmospheric_state(file_id, sounding_dir, atm_state_file, latlon_key_pattern='TROPOMI_{xy}', alt_latlon_key_pattern='TROPOMI_{xy}_BAND7'):
