...
@pytest.mark.compare_test
def test_compare_retrieval_tes(end_to_end_run_dir, tes_test_expected_dir):
...
@pytest.mark.compare_test
def test_compare_retrieval_airs_irk(airs_irk_test_expected_dir, end_to_end_run_dir):
