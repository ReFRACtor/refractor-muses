...
class DeclarativeOutput(object):
        ...
        for cl_type in inspect.getmro(cls):
            ...
            for func_name, func in members:
                if hasattr(func, "_output_type"):
                    ...
                    data_defs = cls.output_definition[output_type] = cls.output_definition.get(output_type, {})
    ...
    def register_output(self, output):
        ...
        for func_name, data_name in self.output_definition.get(OutputType.dataset, {}).items():
            output.register_dataset(data_name, getattr(self, func_name))

        for func_name, data_name in self.output_definition.get(OutputType.attribute, {}).items():
