...
from refractor.framework import refractor_config, read_shelve  # type: ignore
...
def simulation_example_config(**kwargs):
    ...
    l1b_filename = os.path.join(
        test_in_dir,
        "OMI-Aura_L1-OML1BRUG_2016m0414t2324-o62498_v003-2016m0415t050532.he4",
    )
    irr_filename = os.path.join(
        test_in_dir,
        "OMI-Aura_L1-OML1BIRR_2016m0414t0337-o62486_v003-2016m0621t174011.he4",
    )
