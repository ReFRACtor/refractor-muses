...
from refractor.omi.level1 import OmiLevel1RadianceFile, OmiLevel1IrradianceFile, OmiLevel1Reflectance
...
class OmiLevel1Creator(creator.base.Creator):
    ...
    def create(self, **kwargs):
        ...
        return OmiLevel1RadianceFile(self.input_filename(), self.along_track_index(), self.across_track_indexes())
...
class OmiReflectanceCreator(creator.base.Creator):
    ...
    def create(self, **kwargs):
        ...
        return OmiLevel1Reflectance(self.input_filename(), self.along_track_index(), self.across_track_indexes(), self.solar_model())

def retrieval_base_config_definition(l1b_file, along_track_index, across_track_indexes, irradiance_file=None, **kwargs):
    ...
    if irradiance_file is not None:
        ...
        config_def['solar_model']['across_track_indexes'] = np.array(across_track_indexes)
...
def retrieval_muses_config_definition(l1b_file, along_track_index, across_track_indexes, osp_dir, gmao_dir=None, **kwargs):

    config_def = retrieval_base_config_definition(l1b_file, along_track_index, across_track_indexes, **kwargs)
    ...
    if gmao_dir is not None:
        ...
        config_def['atmosphere']['temperature']['creator'] = creator.atmosphere.TemperatureLevel
        config_def['atmosphere']['temperature']['pressure'] = creator.gmao.PressureGMAO
        config_def['atmosphere']['temperature']['temperature_profile'] = creator.gmao.TemperatureProfileGMAO
        ...
        config_def['atmosphere']['temperature']['creator'] = creator.muses.TemperatureMUSES
