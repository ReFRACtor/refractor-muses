...
class MusesOpticalDepthFile(rf.AbsorberXSec):
    ...
    def __init__(
        ...
        # This doesn't actually work correctly, and isn't retrieved anyways.
        # This was historically TROPOMITEMPSHIFTBAND3. If we need to put this in,
        # we'll need to get this working
